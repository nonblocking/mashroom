    ...
    interval = setInterval(async () => {
        ...
        if (collectorService) {
            ...
            if (httpPoolStats) {
                ...
                collectorService.gauge('mashroom_http_proxy_max_connections', 'Mashroom HTTP Proxy Max Connections').set(config.maxTotalSockets);
            ...
            if (httpsPoolStats) {
                ...
                collectorService.gauge('mashroom_https_proxy_max_connections', 'Mashroom HTTPS Proxy Max Connections').set(config.maxTotalSockets);
