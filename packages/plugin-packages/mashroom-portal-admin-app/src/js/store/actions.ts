...
export const setSelectedPortalAppPermittedRoles = (roles: Array<string> | undefined | null) => {
    return {
...
export const setSelectedPageRefData = (pageRef: MashroomPortalPageRef | undefined | null) => {
    return {
...
export const setSelectedPagePermittedRoles = (roles: Array<string> | undefined | null) => {
    return {
...
export const setSelectedSitePermittedRoles = (roles: Array<string> | undefined | null) => {
    return {
