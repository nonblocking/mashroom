...
export const SITES_COLLECTION = 'mashroom-portal-sites';
...
export const PORTAL_JS_FILE = 'portal-client.js';
export const SYSTEMJS_JS_FILE = 'systemjs.js';

export const DEFAULT_SITE_ID = 'default';

export const WINDOW_VAR_PORTAL_SERVICES = 'MashroomPortalServices';
export const WINDOW_VAR_PORTAL_API_PATH = 'MashroomPortalApiPath';
export const WINDOW_VAR_PORTAL_PAGE_ID = 'MashroomPortalPageId';
export const WINDOW_VAR_PORTAL_SITE_URL = 'MashroomPortalSiteUrl';
...
export const WINDOW_VAR_PORTAL_WARN_BEFORE_AUTHENTICATION_EXPIRATION_SEC = 'MashroomPortalWarnBeforeAuthExpirationSec';
export const WINDOW_VAR_PORTAL_ON_AUTHENTICATION_EXPIRATION = 'MashroomPortalOnAuthenticationExpiration';
export const WINDOW_VAR_PORTAL_AUTHENTICATION_EXPIRED_MESSAGE = 'MashroomPortalAuthenticationExpiredMessage';
