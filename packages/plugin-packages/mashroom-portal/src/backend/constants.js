...
export const WINDOW_VAR_PORTAL_SITE_URL = 'MashroomPortalSitePath';
...
export const WINDOW_VAR_PORTAL_LOGOUT_AFTER_INACTIVITY_SEC = 'MashroomPortalLogoutAfterInactivitySec';
