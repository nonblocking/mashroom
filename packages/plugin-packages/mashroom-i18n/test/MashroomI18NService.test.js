...
describe('MashroomI18NService', () => {
    ...
    it('determines the browser locale correctly', () => {
        const i18nService = new MashroomI18NService(['fr', 'en', 'de'], 'de', '', '', dummyLoggerFactory);
    ...
    it('determines the message correctly', () => {
        ...
        const i18nService = new MashroomI18NService(['fr', 'en', 'de'], 'de', translationsFolder, '', dummyLoggerFactory);
