...
const initDisplayMode = () => {
    ...
    let mode = document.documentElement.getAttribute('data-tailwind-theme');
    ...
    document.documentElement.setAttribute('data-tailwind-theme', mode);
    (globalThis as any).__MASHROOM_PORTAL_DARK_MODE__ = mode === 'dark';
};

(globalThis as any).toggleDisplayMode = () =>  {
    const mode = document.documentElement.getAttribute('data-tailwind-theme');
    const newMode = mode === 'dark' ? 'light' : 'dark';
    document.documentElement.setAttribute('data-tailwind-theme', newMode);
